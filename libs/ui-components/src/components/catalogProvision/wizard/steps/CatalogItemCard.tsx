...
import {
  ...
  catalogItemResourceParts, catalogItemSubtitle
} from '@osac/ui-components/components/catalog/catalogItemDisplay.ts';
import { CatalogItemIcon } from '@osac/ui-components/icons.tsx';
